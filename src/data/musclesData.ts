...
export const MUSCLES_DATA: Record<MuscleGroupKey, MuscleGroupInfo> = {
  ...
  tibialis_anterior: {
    ...
    name: '小腿前側肌群 (脛前肌 / 趾長伸肌)',
    nameEn: 'Anterior Lower Leg (Tibialis Anterior & Extensors)',
    latinName: 'Musculus Tibialis Anterior & Extensores Digitorum',
    split: 'legs',
    functionSummary: '包含脛前肌、趾長伸肌與𧿹長伸肌。主導踝關節背屈 (Dorsiflexion，腳尖向上勾起)、伸展各腳趾與足內翻。在跑步跳躍著地、急停減速時提供強大的離心緩衝避震，維持足弓剛性並預防足下垂與脛前疼痛 (Shin Splints)。',
    originInsertion: '起點：脛骨外側面中上段、腓骨前緣及小腿骨間膜。止點：肌腱穿過踝部伸肌支持帶下方，分別止於第一蹠骨底、內側楔骨以及第 2~5 腳趾各趾骨背側。',
    cameraFocus: {
      target: [0, 0.25, 0],
      position: [0.15, 0.25, 1.25],
    },
    themeColor: '#06b6d4',
    exercises: [
      {
        ...
        name: '靠牆腳尖背屈提膝',
        nameEn: 'Tibialis Wall Raise',
        type: '孤立動作 (Isolation)',
        equipment: '自重 Bodyweight',
        difficulty: '入門 Beginner',
        description: '背靠牆壁、雙腳往前踩，雙腳腳尖全力朝小腿前側向上勾起，至頂峰收縮 1~2 秒後慢速離心放回。',
        cues: [
          '膝關節伸直鎖定，腳跟著地作為旋轉軸心',
          '腳尖向天花板全力勾起至極限，頂峰維持強烈收縮感受',
          '慢速 2~3 秒下放，輕觸地面後立即再次發力勾起',
        ],
        precautions: [
          '膝蓋切勿隨意彎曲借力，軀幹保持平直',
        ],
      ...
      {
        id: 'ex-db-dorsiflexion',
        name: '坐姿負重腳尖背屈',
        nameEn: 'Seated Weighted Dorsiflexion',
        type: '孤立動作 (Isolation)',
        equipment: '啞鈴 Dumbbell',
        difficulty: '中階 Intermediate',
        description: '坐於長凳邊緣，小腿懸空放置，腳掌前端懸掛啞鈴或彈力帶進行抗阻踝背屈。',
        cues: [
          '小腿平放於長凳上固定，腳踝完全懸空於邊緣外',
          '以腳踝為軸心，慢速下垂拉長脛前肌後全力向上勾起',
        ],
        precautions: [
          '確保啞鈴穩固，避免滑落',
        ],
  ...
  gastrocnemius: {
    ...
    split: 'legs',
    functionSummary: '小腿三頭肌表層主力，分為內側頭與外側頭（雙關節肌）。在膝關節伸直鎖定時主導踝關節強力跖屈（踮腳尖），賦予極限衝刺蹬地與垂直起跳爆發力。',
    originInsertion: '起點：內側頭起於股骨內側髁後面，外側頭起於股骨外側髁後面。止點：向下匯入阿基里斯腱（跟腱），止於跟骨結節。',
    cameraFocus: {
      target: [0, 0.32, 0],
    ...
    exercises: [
      {
        ...
        equipment: '器械 Machine',
        difficulty: '入門 Beginner',
        description: '在膝關節伸直鎖定狀態下，全力針對腓腸肌雙頭給予最大伸展與向心收縮。',
        cues: [
          '前腳掌踩在踏板邊緣，膝蓋微屈緊繃但不彎曲',
          '底端充分下放腳跟感受阿基里斯腱與肌肉深層拉長停頓 1 秒',
          '腳拇指球強力蹬起至最高點踮腳尖，頂峰收縮 1~2 秒',
        ],
        precautions: [
          '避免利用跟腱彈性上下彈跳借力，需用肌肉主動離心控制',
        ],
      ...
      },
      {
        ...
        equipment: '器械 Machine',
        difficulty: '中階 Intermediate',
        description: '髖關節前屈 90 度時進行提踵，深層拉伸腿後側與腓腸肌上端附著點，提供極致離心張力。',
        cues: [
          '軀幹與大腿呈 90 度，背部保持平直',
          '下放時感受小腿頂端強烈拉扯感，蹬起時專注於內外雙頭擠壓',
        ],
        precautions: [
          '腰部切忌弓背或塌腰借力',
        ],
  ...
  soleus: {
    ...
    split: 'legs',
    functionSummary: '位於腓腸肌深層的扁平肌（單關節肌），富含高比例慢肌纖維。在膝關節屈曲時（此時腓腸肌放鬆主動不足）主導踝關節跖屈，是長跑耐力、站立姿態抗重力維持與小腿橫向厚度的根基。',
    originInsertion: '起點：腓骨頭及骨幹上部後面、脛骨比目魚肌線。止點：向下與腓腸肌腱融合為跟腱，止於跟骨結節。',
    cameraFocus: {
      target: [0, 0.20, 0],
      position: [0.15, 0.22, -1.25],
    },
    themeColor: '#8b5cf6',
    exercises: [
      {
        ...
        equipment: '器械 Machine',
        difficulty: '入門 Beginner',
        description: '屈膝 90 度使雙關節的腓腸肌處於主動不足放鬆，100% 孤立鍛鍊深層的比目魚肌。',
        cues: [
          '坐於器械上，護墊壓在大腿下端靠近膝蓋處',
          '全活動度慢速提踵，底端深層拉長停頓 1 秒',
          '頂峰全力擠壓小腿下側厚度',
        ],
        precautions: [
          '重量適中，避免腳踝過度外翻或內翻晃動造成韌帶受壓',
        ],
  ...
  fibularis: {
    key: 'fibularis',
    name: '腓骨肌群 (外側小腿)',
    nameEn: 'Fibularis (Peroneal) Muscles',
    latinName: 'Musculi Fibulares (Peroneus Longus, Brevis, Tertius)',
    split: 'legs',
    functionSummary: '包含腓骨長肌、腓骨短肌與第三腓骨肌。主要主導踝關節外翻 (Eversion) 與維持外側足弓剛性，是預防腳踝內翻「翻船 (Inversion Sprain)」的最重要主動動態防線，並在橫向變向移動與單腿著地時提供關鍵橫向穩定。',
    originInsertion: '起點：腓骨頭及腓骨外側面中上段。止點：肌腱繞經外踝後下方轉折，止於第一蹠骨底、內側楔骨及第五蹠骨粗隆。',
    cameraFocus: {
      target: [0.15, 0.25, 0],
    ...
    exercises: [
      {
        id: 'ex-banded-ankle-eversion',
        name: '彈力帶坐姿踝外翻',
        nameEn: 'Seated Banded Ankle Eversion',
        type: '孤立動作 (Isolation)',
        equipment: '自重 Bodyweight',
        difficulty: '入門 Beginner',
        description: '坐在長凳上，彈力帶固定於內側並套住前腳掌外側，抗阻向外旋轉勾動腳踝，精準孤立腓骨長肌與短肌。',
        cues: [
          '小腿維持垂直不晃動，旋轉軸心完全鎖定在腳踝關節',
          '前腳掌強力朝外上方勾起並外展，頂峰短暫停頓 1 秒擠壓小腿外側',
          '慢速 2~3 秒抗阻離心回放至中立位',
        ],
        precautions: [
          '避免用整條大腿或膝蓋外旋代償腳踝的外翻動作',
        ],
        tags: ['踝關節防護', '抗翻船防扭傷', '外側穩定度'],
      },
      {
        id: 'ex-lateral-bound-stick',
        name: '單腿側向跳躍穩態著地',
        nameEn: 'Lateral Bound & Stick',
        type: '複合動作 (Compound)',
        equipment: '自重 Bodyweight',
        difficulty: '中階 Intermediate',
        description: '由單腿全力向側方蹬出，另一腿著地時瞬間吸收外側衝擊力，深度活化腓骨肌群的反應性動態剛性。',
        cues: [
          '單腿微屈蓄力，向側邊橫向爆發躍出',
          '著地腳以前腳掌外側與足弓協同抓地，膝關節與腳尖對齊向前，停頓穩住 2 秒',
        ],
        precautions: [
          '著地時膝蓋嚴禁向內扣 (Valgus)，腳踝需保持極高剛性不晃動',
        ],
        tags: ['橫向敏捷', '關節剛性', '動態本體感覺'],
      },
    ],
  },
